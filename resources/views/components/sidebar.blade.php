                ...
                @if (true)
                    <li x-data="{ open: false }">
                        ...
                        <ul x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            <li><a href="{{ route('sidebar.cargaAcademica') }}"
                ...
                @if (true)
                    <li x-data="{ open: false }">
                        ...
                        <ul x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            <li><a href="{{ route('sidebar.VerCargaAcademica') }}"
                                    class="block p-2 hover:bg-gray-800">Mi
                ...
                @if (true)
                    <li x-data="{ open: false }">
                        ...
                        <ul x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            x-transition:leave-start="transform opacity-100 scale-100"
                            x-transition:leave-end="transform opacity-0 scale-95" class="submenu ml-4 space-y-2">
                            <li><a href="{{ route('boletin.index') }}" class="block p-2 hover:bg-gray-800">Ver boletin
                                    de
                                    calificaciones</a>
                            </li>
