            ...
            <ul class="space-y-4">
                <li x-data="{ open: false }">
                    ...
                    <ul x-show="open" x-transition:enter="transition ease-out duration-200"
                        ...
                        @can('es_administrador_o_coordinador')
...
<li><a href="{{ route('sidebar.formulario_carga_academica') }}" class="block p-2 hover:bg-gray-800">Crear
        carga académica</a></li>

<li><a href="{{ route('sidebar.inscribir') }}" class="block p-2 hover:bg-gray-800">Inscribir
        estudiante</a></li>

<li><a href="{{ route('sidebar.modificar_calificacion') }}" class="block p-2 hover:bg-gray-800">Modificar
        calificaciones</a></li>

<li><a href="{{ route('sidebar.modirepresentantes') }}" class="block p-2 hover:bg-gray-800">Modificación de datos
        representante</a> </li>

<li><a href="{{ route('sidebar.modiestudiantes') }}" class="block p-2 hover:bg-gray-800">Modificación de datos
        estudiante</a> </li>

<li><a href="{{ route('sidebar.modidocentes') }}" class="block p-2 hover:bg-gray-800">Modificación datos de
        Docente</a></li>
...
<li x-data="{ open: false }">
    <a href="#" class="p-2 font-semibold text-xl hover:bg-gray-700 flex items-center justify-between"
        @click="open = !open">
        <div>
            <i class="fa-solid fa-chalkboard-user icono-side"></i>
            Docente
