<x-app-layout>
    ...
    <h1 class="h1Docente">Coordinador: Modificar notas</h1>
...
<div class="ajuste-tablas">
    ...
    <div class="col-lg-4">
            ...
            <div class="panel-heading text-table-head">Panel de cargas academicas</div>
                <div class="panel-body">
                    <form class="form-signin" id="settingsform" autocomplete="off">
                        <label class="text-default-black">Buscar asignatura cargada</label>
        ...
        <form class="form-signin" id="settingsform" autocomplete="off">
            <label class="text-default-black">Buscar seccion cargada</label>
                <div class="input-group" style="width:100%">
        ...
        <div class="col-lg-8">
            <div class="panel panel-carga-seccion panel-default">
                <div class="panel-heading text-table-head">Listado de alumnos inscritos: Notas cargadas</div>
                <div class="panel-body">
                                ...
                                <table width="100%"
                                    ...
                                    <thead>
                                        <tr role="row" class="info-table-head">
                                            ...
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 100px;">Nueva</th>
