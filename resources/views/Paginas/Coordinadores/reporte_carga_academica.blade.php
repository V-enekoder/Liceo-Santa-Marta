                    ...
                    <div class="card-body">
                        <form id="cargaAcademicaForm" method="POST">
                            ...
                            <div class="form-group row">
                                <label class="text-default-black" for="persona_id" class="col-md-4 col-form-label text-md-right">Seleccione Persona:</label>
                                <div class="col-md-6">
                                    <select id="persona_id" class="form-control @error('persona_id') is-invalid @enderror" name="persona_id" required>
                            ...
                            <div class="form-group row">
                                <label class="text-default-black" for="periodo_id" class="col-md-4 col-form-label text-md-right">Seleccione Período Académico:</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" class="mt-5 mb-1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Buscar</button>
                                </div>
                            </div>
                        </form>
                        ...
                        @isset($materias)
                            <div class="mt-4">
                                ...
                                <ul>
                                    ...
                                    @empty
                                        <li>No se encontraron materias asignadas para este docente en el período especificado.</li>
                                    @endforelse
                                </ul>
                            </div>
                        @endisset
